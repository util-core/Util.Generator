...
namespace Util.Generators {
    ...
    public class Generator : IGenerator {
        ...
        protected virtual void GenerateProject( ProjectContext projectContext ) {
        ...
        protected virtual void GenerateEntity( EntityContext entityContext, List<ITemplate> templates ) {
            _logger.BeginGenerateEntity( entityContext );
            if ( IsSkip( entityContext ) )
                return;
            foreach ( var template in templates ) {
                template.Render( entityContext.Clone() );
