...
namespace Util.Generators.Tests {
    ...
    public class GeneratorTest {
        ...
        public void TestGenerate_1() {
            ...
            //设置模拟操作
            _mockGeneratorContextBuilder.Setup( t => t.Build() ).Returns( generatorContext );
            ...
            //验证
            mockTemplate.Verify( t => t.Render( It.IsAny<EntityContext>() ), Times.Once );
        }
        ...
        public void TestGenerate_2() {
            ...
            //验证
            mockTemplate.Verify( t => t.Render( It.IsAny<EntityContext>() ), Times.Once );
            mockTemplate2.Verify( t => t.Render( It.IsAny<EntityContext>() ), Times.Once );
        }
        ...
        public void TestGenerate_3() {
            ...
            //验证
            mockTemplate.Verify( t => t.Render( It.IsAny<EntityContext>() ), Times.Exactly( 2 ) );
        }
        ...
        public void TestGenerate_4() {
            ...
            //验证
            mockTemplate.Verify( t => t.Render( It.IsAny<EntityContext>() ), Times.Exactly( 2 ) );
            mockTemplate2.Verify( t => t.Render( It.IsAny<EntityContext>() ), Times.Exactly( 2 ) );
        }
        ...
        public void TestGenerate_5() {
            ...
            //验证
            mockTemplate.Verify( t => t.Render( It.IsAny<EntityContext>() ), Times.Exactly( 4 ) );
            mockTemplate2.Verify( t => t.Render( It.IsAny<EntityContext>() ), Times.Exactly( 4 ) );
        }
        ...
        public void TestGenerate_6() {
            ...
            //验证
            mockTemplate.Verify( t => t.Render( It.IsAny<EntityContext>() ), Times.Never );
        }
