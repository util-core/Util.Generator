...
namespace Util.Generators.Tests.Contexts {
    ...
    public class GeneratorContextBuilderTest {
        ...
        public GeneratorContextBuilderTest() {
            _context = new GeneratorContextBuilder( NullGeneratorLogger.Instance, new MockGeneratorOptionsBuilder(), new MockMetadataServiceFactory(), new TypeConverterFactory() ).Build();
        }
        ...
        public void TestGeneratorContext_Path_2() {
            _context = new GeneratorContextBuilder( NullGeneratorLogger.Instance, new MockGeneratorOptionsBuilder2(), new MockMetadataServiceFactory(),new TypeConverterFactory() ).Build();
